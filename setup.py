...
setuptools.setup(
    ...
    description="We are pleased to announce that the QuantStart software development team are currently in the process of a complete redevelopment of QSTrader.",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/qstrader",  # 模块github地址
